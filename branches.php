...
$branch_info -> set_sortname('BranchId', 'ASC');
...
$branch_info -> set_col_width('Branch_Name', '35px');
$branch_info -> set_col_width('BranchId', '20px');
$branch_info -> set_col_width('Location', '35px');

//$branch_info -> set_col_height('');
